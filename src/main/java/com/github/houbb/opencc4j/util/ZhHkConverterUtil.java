...
public final class ZhHkConverterUtil {
    ...
    // 单独的 HK
    private static final ZhConvertBootstrap HK_SELF_BS = ZhConvertBootstrap
            .newInstance()
            .segment(Segments.hkSelfFastForward())
            .dataMap(DataMaps.hongKongSelf())
            .init();
    ...
    public static String toSimple(final String original) {
        //1. hk==>标准==》简体
        String temp = HK_SELF_BS.toSimple(original);
    ...
    public static String toTraditional(final String original) {
        ...
        return HK_SELF_BS.toTraditional(temp);
    }
