 ...
 * @version 1.13.0
 */
public final class ZhJpConverterUtil {

    /**
     *  zh converter util
     * @since 1.13.0
     */
    private ZhJpConverterUtil(){}
    ...
    private static final ZhConvertBootstrap DEFAULT_BOOTSTRAP = ZhConvertBootstrap
            .newInstance()
            .segment(Segments.jpFastForward())
            .dataMap(DataMaps.japan())
            .init();
     ...
     * @since 1.13.0
     */
    private static final ZhConvertBootstrap JP_SELF_BS = ZhConvertBootstrap
            .newInstance()
    ...
    public static String toSimple(final String original) {
        String temp = JP_SELF_BS.toSimple(original);
        return ZhConverterUtil.toSimple(temp);
    }
