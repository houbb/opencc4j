 ...
 */
@Deprecated
public class ZhConvertBootstrap_OLD implements ZhConvert {
     ...
     * @since 1.2.0
     */
    private ZhConvertBootstrap_OLD(){}
     ...
     * @since 1.1.0
     */
    public static ZhConvertBootstrap_OLD newInstance() {
        return new ZhConvertBootstrap_OLD();
    }
     ...
     */
    @Deprecated
    public static ZhConvertBootstrap_OLD newInstance(final Segment segment) {
        ZhConvertBootstrap_OLD bs = newInstance();
        bs.segment(segment);
     ...
     * @return 引导类本身
     */
    public ZhConvertBootstrap_OLD segment(final Segment segment) {
     ...
     * @since 1.7.0
     */
    public ZhConvertBootstrap_OLD dataMap(IDataMap dataMap) {
