...
public class MyFooDataMapExtra2 extends AbstractDataMapExtra {

    public MyFooDataMapExtra2(IDataMap baseDataMap) {
        super(baseDataMap);
    }

    // 默认在基本的繁简体基础上拓展
    public MyFooDataMapExtra2() {
    ...
    protected Map<String, List<String>> tsPhraseExtra() {
        // 估计写了个错的，用来演示
        return of("風玥", Arrays.asList("风月2"));
    }
    ...
    protected Map<String, List<String>> stPhraseExtra() {
        // 估计写了个错的
        return of("风月", Arrays.asList("風玥2"));
    }
